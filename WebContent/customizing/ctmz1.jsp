...
<body>
    <div class="no1">
      ...
      <div class="color">
         <div id="color_output"><img id="sphere" src="/kanye/image/tan.png"></div>
      ...
      <div class="color slide">
         ...
         <div class="btcolor" id="color5"><img id="sphere"></div><br>
         <div class="btcolor" id="color6"><img id="sphere"></div><br>
      </div>
